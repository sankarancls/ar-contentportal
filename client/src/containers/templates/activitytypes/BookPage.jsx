...
import BookForm from '../../../components/templates/activitytypes/BookForm.jsx';
...
class BookPage extends React.Component {
    ...
    */    
    constructor(props){
        ...
        this.deleteImageFile = this.deleteImageFile.bind(this);
            ...
            if(json) {
                ...
                if(json['content']){
                    ...
                    if(common_content['common_content_info']){
                        ...
                        activityContent['bgimage'] = common_content['common_content_info']['bgimage'];                      
                    }
                    this.setState({
                        textFields:textFields,
                        files:[],
	...
	*/	
	changeFile (event,type){        
        const activityContent = this.state.activityContent
        if(type=='content'){
            activityContent['bgimage'] = event.target.files[0]['name']
        }        
	...
	*/
    deleteImageFile(type){	
        if(type=='content') {
            const activityContent = this.state.activityContent;
            this.deleteFile(activityContent['bgimage']);
            activityContent['bgimage'] = '';
            this.setState({
                activityContent:activityContent,
            })
        } 
            ...
            <div>
                {!this.state.showAssessmentComponent ?
                    <BookForm
                        ...
                        deleteImageFile = {this.deleteImageFile}
