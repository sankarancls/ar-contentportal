...
import CoreForm from '../../../components/templates/activitytypes/DeckForm.jsx';
            ...
            if(json) {
                ...
                if(json['content']){                    
                    ...
                    if(common_content['common_content_info']){	
						...
						let picture_count = 0;
						const tifOptions = Object.keys(common_content['common_content_info']['picture']).map(key =>						
							activityContent['picture'].push(common_content['common_content_info']['picture'][key])
							//picture_count++
						)
						
                        glossary_length = activityContent['picture'].length						
                    }
    ...
    */
    loadPictures(event) {
        ...
        for(var i=0;i<event.target.files.length;i++){
            ...
            activityContent['picture'].push(addnewImage);
        }
