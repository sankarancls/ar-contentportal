        ...
        <div>
            <Table>
                ...
                <TableBody displayRowCheckbox = {false}>
                    {questionContent.drag.map((row,index)=>(                   
                        <TableRow key={index} >                       
                            <TableRowColumn className="table-td" style={{textAlign:styles.left_align}}>{row.text}</TableRowColumn>
                            <TableRowColumn className="table-td" style={{textAlign:styles.left_align}}>{row.answer}</TableRowColumn>
                            <TableRowColumn className="table-td" style={{textAlign:styles.left_align,wordWrap:'break-word', whiteSpace:'normal'}}>{row.feedback['text']}</TableRowColumn>
